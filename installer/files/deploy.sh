...
NAT_GATEWAY_A="$(sdget 0.public.net.cld.internal gateway-id)"
NAT_GATEWAY_B="$(sdget 1.public.net.cld.internal gateway-id)"
NAT_GATEWAY_C="$(sdget 2.public.net.cld.internal gateway-id)"
